...
public class Inventory : MonoBehaviour
{
    ...
    */
    ...
    {
        foreach (GameObject b in throwables)
        {
            if (b.name == name) //this is equivalent to asking if this slot is empty to place an item in
            {
                return true; //place the item in this empty slot
            }
        }
        return false;
    }
